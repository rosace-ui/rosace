...
**Remaining**: route `ScrollView::live` through this (today it paints into the base canvas; needs hit-testing through the offset first, since ScrollView content is interactive — demo-wide blast radius); content > `MAX_TL_DIM` (4096px) re-render windowing.

...
**Status**: Step 1 (real keyboard editing) LANDED 2026-07-12 — see `.steering/PHASE_28.md` for full detail. Steps 2-4 (TextArea, real OS IME, rosace-forms wiring) not started.
...
**Status**: SCOPED, NOT STARTED — see `.steering/PHASE_30.md`.

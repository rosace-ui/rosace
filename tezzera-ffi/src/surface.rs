...
//!
//! `GpuPresenter::new<W>` (`tezzera-compositor`) is already generic over
...
//! `tezzera-compositor` was built against.
...
// itself is never dereferenced by TEZZERA code (only handed to wgpu, which

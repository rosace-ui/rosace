...
//! see `tezzera-cli/src/commands/new.rs`'s `jni_mangle`, which computes this
//! exact name for a real app's bundle id at `tzr new` codegen time). This
//! stub hardcodes a throwaway package (`dev.tezzera.stub`, class
//! `MainActivity`) purely to prove the shape compiles, links, and resolves
//! by name — `tzr new`'s real codegen generates the equivalent per-app.
//!
//! Build: `cargo build -p tezzera-ffi --example android_stub --target
...
//! `Java_dev_tezzera_stub_MainActivity_native*` name.
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_tezzera_stub_MainActivity_nativeInit(
    env: JNIEnv,
    _class: JObject,
    surface: JObject,
    width: jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_tezzera_stub_MainActivity_nativeResize(
    _env: JNIEnv,
    _class: JObject,
    handle: jlong,
    width: jint,
    ...
    let safe_area = tezzera_core::SafeArea {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_tezzera_stub_MainActivity_nativeInput(
    _env: JNIEnv,
    _class: JObject,
    handle: jlong,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_tezzera_stub_MainActivity_nativeFrame(
    _env: JNIEnv,
    _class: JObject,
    handle: jlong,
) {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_tezzera_stub_MainActivity_nativeShutdown(
    _env: JNIEnv,
    _class: JObject,
    handle: jlong,
) {

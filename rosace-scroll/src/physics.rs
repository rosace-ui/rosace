...
impl ScrollStyle {
    ...
    pub fn default_for_platform(platform: rosace_core::Platform) -> ScrollPhysics {
        ...
        match platform {
            rosace_core::Platform::Ios | rosace_core::Platform::MacOs => {
...
mod tests {
    ...
    fn default_for_platform_is_bounce_on_ios_and_macos() {
        assert!(matches!(
            ScrollStyle::default_for_platform(rosace_core::Platform::Ios),
            ScrollPhysics::Bounce { .. }
        ));
        assert!(matches!(
            ScrollStyle::default_for_platform(rosace_core::Platform::MacOs),
            ScrollPhysics::Bounce { .. }
        ));
    }

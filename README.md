<div align="center">
  ...
  ![Version](https://img.shields.io/crates/v/rosace?color=orange&label=crates.io)
...
> **Published on crates.io** (the badge above shows the current release).
> Rosace is still under active development: APIs are unstable and large parts
> are still being built. Not production-ready yet — but what's here already
> runs fast, and it's installable, not just clonable.
>
> **0.1.1 is prepared but not yet released.** It is source-breaking despite
> the patch bump — it removes `cupertino()` and consolidates 39 crates into

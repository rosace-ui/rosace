...
impl ScrollController {
    ...
    pub fn new() -> Self {
        Self {
            ...
            last_drag_point: tezzera_state::use_atom(None),
            velocity: tezzera_state::use_atom([0.0f32; 2]),
            last_offset_for_velocity: tezzera_state::use_atom([0.0f32; 2]),
            was_pressed: tezzera_state::use_atom(false),
            wheel_idle_time: tezzera_state::use_atom(f32::MAX),
        }
    }

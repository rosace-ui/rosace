...
fn print_usage() {
    println!("rsc — ROSACE CLI");
    println!();
    println!("USAGE:");
    println!("  rsc <COMMAND> [OPTIONS]");
    println!();
    println!("COMMANDS:");
    println!("  new <name>          Scaffold a new ROSACE app (interactive platform picker)
    ...
    println!("EXAMPLES:");
    println!("  rsc dev");
    println!("  rsc dev --target web");
    println!("  rsc dev --target web --port 8080");
    println!("  rsc build --target desktop");
    println!("  rsc build --target web");
}
